        ...
        <div style={{ padding: '1.5rem', maxHeight: 'calc(90vh - 140px)', overflowY: 'auto' }}>
          ...
          {registrationSuccess ? (
            ...
            <div>
              ...
              >
                <div style={{ fontSize: '0.72rem', color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.75rem', fontWeight: 700 }}>
                  Quick Verification Simulation Accounts
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  ...
                  >
                    <div>
                      <div style={{ fontWeight: 700, color: '#C084FC' }}>
                        👑 Super Admin (Full Governance)
                      </div>
                      <div style={{ fontSize: '0.7rem', color: '#94A3B8' }}>
                        ID: <code style={{ color: '#F3E8FF' }}>superadmin</code> | Pass: <code style={{ color: '#F3E8FF' }}>SuperAdmin@2026#</code>
                      </div>
                    </div>
                  ...
                  <button
                    type="button"
                    onClick={() => fillDemoCredentials('admin_ops', 'AdminOps@123')}
                    style={{
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'space-between',
                  ...
                  >
                    <div>
                      <div style={{ fontWeight: 700, color: '#60A5FA' }}>
                        📦 Operations Admin (Approved Staff)
                      </div>
                      <div style={{ fontSize: '0.7rem', color: '#94A3B8' }}>
                        ID: <code style={{ color: '#DBEAFE' }}>admin_ops</code> | Pass: <code style={{ color: '#DBEAFE' }}>AdminOps@123</code>
                      </div>
                    </div>
                  ...
                  <button
                    type="button"
                    onClick={() => fillDemoCredentials('admin_neha', 'NehaAdmin@123')}
                    style={{
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'space-between',
                  ...
                  >
                    <div>
                      <div style={{ fontWeight: 700, color: '#FBBF24' }}>
                        ⏳ Pending Admin Applicant (Neha Sharma)
                      </div>
                      <div style={{ fontSize: '0.7rem', color: '#94A3B8' }}>
                        ID: <code style={{ color: '#FEF3C7' }}>admin_neha</code> | Tests pending approval gate!
                      </div>
                    </div>
